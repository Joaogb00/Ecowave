<template>
  <header class="main-header" :class="{ 'header-scrolled': isScrolled }">
    <div class="header-left">
       <router-link to="/proprietario" ><img class="img-logo" src="../../assets/img/logo.png" alt="EcoWave Logo"></router-link>
    ...
    <div class="header-right">
      ...
      <router-link to="/minhacontaprop" class="router-icon"><i class="bi bi-person-circle user-icon"></i></router-link>
